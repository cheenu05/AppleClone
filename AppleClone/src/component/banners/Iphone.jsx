...
const Iphone = () => {
  return (
  <>
      <div className='w-full h-[500px] bg-[url("")] bg-center bg-cover flex flex-col items-center gap-3 bg-black'>
          <h1 className=' text-white text-5xl font-semibold mt-12' >iPhone 17 Pro</h1>
